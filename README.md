# 🔍 Catalog Validator - Инструмент проверки качества каталога

Автоматическая проверка качества данных в каталогах товаров для русскоязычных e-commerce проектов.
